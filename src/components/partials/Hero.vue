  ...
  <div class="hero">
    <div class="hero-left">
      <div class="landing">
        ...
        <div class="github-buttons">
          ...
          <Badge
            href="/"
            badge-url="https://img.shields.io/github/license/Pincer-org/Pincer"
            alt="GitHub"
          />
          <Badge
        ...
        <p>
          ...
          for anyone in the Python community to build their bot with.
        </p>
        ...
        <nav>
          <ul class="explore-container">
            <li class="explore-item">
              ...
              <a href="https://github.com/pincer-org/pincer"
                >Take a look at the GitHub repository</a
              >
            </li>
            <li class="explore-item">
            ...
            <li class="explore-item">
              ...
              <a href="https://pypi.org/project/Pincer"
                >Download the PyPI package</a
              >
            </li>
            <li class="explore-item">
              <img src="@/assets/icons/read_the_docs.svg" alt="ReadTheDocs" />
              <a href="https://docs.pincer.dev"
                >Get Started with the documentation</a
              >
            </li>
          </ul>
        </nav>
    ...
    <div class="hero-right">
      ...
      <img
        ...
        src="@/assets/decorations/arrow.svg"
        alt="..."
      />
