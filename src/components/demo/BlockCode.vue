    ...
    <pre>
      <code>
        ...
        <T c="p">class</T> <T c="y">Bot</T>(Client)<T c="p">:</T>
          ...
          <T c="b">@command</T>(<T c="k">name</T><T c="p">=</T><T c="g">"say"</T>, <T c="k">description</T><T c="p">=</T><T c="g">"Send a custom message!"</T>)
        ...
        <T c="p">if</T> __name__ <T c="p">==</T> <T c="g">"__main__"</T>:
          bot = <T c="b">Bot</T>(<T c="k">token</T><T c="p">=</T><T c="g">"WfVc18N6kJAbMzMqGTE1NhT5.YVCuNA.5OrfKz5KADVhIlxMgXjSs4aQcMk"</T>)
          bot.<T c="b">run</T>()
      </code>
    </pre>
  </figure>
